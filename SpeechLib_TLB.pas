...
// $Rev: 17244 $
// File generated on 09.07.14 14:25:25 from Type Library described below.
...
// *********************************************************************//
  ISpObjectToken = interface(ISpDataKey)
    ...
    function IsUISupported(pszTypeOfUI: PWideChar; var pvExtraData: Pointer; cbExtraData: LongWord; 
    ...
    function DisplayUI(var hWndParent: _RemotableHandle; pszTitle: PWideChar; 
                       pszTypeOfUI: PWideChar; var pvExtraData: Pointer; cbExtraData: LongWord; 
...
// *********************************************************************//
  ISpVoice = interface(ISpEventSource)
    ...
    function DisplayUI(var hWndParent: _RemotableHandle; pszTitle: PWideChar; 
                       pszTypeOfUI: PWideChar; var pvExtraData: Pointer; cbExtraData: LongWord): HResult; stdcall;
  end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpNotifyTranslatorProperties= class;
{$ENDIF}
  TSpNotifyTranslator = class(TOleServer)
  private
    FIntf: ISpNotifyTranslator;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpNotifyTranslatorProperties;
    function GetServerProperties: TSpNotifyTranslatorProperties;
{$ENDIF}
  ...
  public
    ...
    function InitWin32Event(var hEvent: Pointer; fCloseHandleOnRelease: Integer): HResult;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpNotifyTranslatorProperties read GetServerProperties;
{$ENDIF}
  end;
...
// *********************************************************************//
 TSpNotifyTranslatorProperties = class(TPersistent)
  private
    FServer:    TSpNotifyTranslator;
    function    GetDefaultInterface: ISpNotifyTranslator;
    constructor Create(AServer: TSpNotifyTranslator);
  protected
  public
    property DefaultInterface: ISpNotifyTranslator read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpResourceManagerProperties= class;
{$ENDIF}
  TSpResourceManager = class(TOleServer)
  private
    FIntf: ISpResourceManager;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpResourceManagerProperties;
    function GetServerProperties: TSpResourceManagerProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpResourceManagerProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpResourceManagerProperties = class(TPersistent)
  private
    FServer:    TSpResourceManager;
    function    GetDefaultInterface: ISpResourceManager;
    constructor Create(AServer: TSpResourceManager);
  protected
  public
    property DefaultInterface: ISpResourceManager read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpStreamFormatConverterProperties= class;
{$ENDIF}
  TSpStreamFormatConverter = class(TOleServer)
  private
    FIntf: ISpStreamFormatConverter;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpStreamFormatConverterProperties;
    function GetServerProperties: TSpStreamFormatConverterProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpStreamFormatConverterProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpStreamFormatConverterProperties = class(TPersistent)
  private
    FServer:    TSpStreamFormatConverter;
    function    GetDefaultInterface: ISpStreamFormatConverter;
    constructor Create(AServer: TSpStreamFormatConverter);
  protected
  public
    property DefaultInterface: ISpStreamFormatConverter read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpMMAudioEnumProperties= class;
{$ENDIF}
  TSpMMAudioEnum = class(TOleServer)
  private
    FIntf: IEnumSpObjectTokens;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpMMAudioEnumProperties;
    function GetServerProperties: TSpMMAudioEnumProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpMMAudioEnumProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpMMAudioEnumProperties = class(TPersistent)
  private
    FServer:    TSpMMAudioEnum;
    function    GetDefaultInterface: IEnumSpObjectTokens;
    constructor Create(AServer: TSpMMAudioEnum);
  protected
  public
    property DefaultInterface: IEnumSpObjectTokens read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpStreamProperties= class;
{$ENDIF}
  TSpStream = class(TOleServer)
  private
    FIntf: ISpStream;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpStreamProperties;
    function GetServerProperties: TSpStreamProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpStreamProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpStreamProperties = class(TPersistent)
  private
    FServer:    TSpStream;
    function    GetDefaultInterface: ISpStream;
    constructor Create(AServer: TSpStream);
  protected
  public
    property DefaultInterface: ISpStream read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpCompressedLexiconProperties= class;
{$ENDIF}
  TSpCompressedLexicon = class(TOleServer)
  private
    FIntf: ISpLexicon;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpCompressedLexiconProperties;
    function GetServerProperties: TSpCompressedLexiconProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpCompressedLexiconProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpCompressedLexiconProperties = class(TPersistent)
  private
    FServer:    TSpCompressedLexicon;
    function    GetDefaultInterface: ISpLexicon;
    constructor Create(AServer: TSpCompressedLexicon);
  protected
  public
    property DefaultInterface: ISpLexicon read GetDefaultInterface;
  published
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSpNullPhoneConverterProperties= class;
{$ENDIF}
  TSpNullPhoneConverter = class(TOleServer)
  private
    FIntf: ISpPhoneConverter;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSpNullPhoneConverterProperties;
    function GetServerProperties: TSpNullPhoneConverterProperties;
{$ENDIF}
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSpNullPhoneConverterProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSpNullPhoneConverterProperties = class(TPersistent)
  private
    FServer:    TSpNullPhoneConverter;
    function    GetDefaultInterface: ISpPhoneConverter;
    constructor Create(AServer: TSpNullPhoneConverter);
  protected
  public
    property DefaultInterface: ISpPhoneConverter read GetDefaultInterface;
  published
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpNotifyTranslatorProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpNotifyTranslator.GetServerProperties: TSpNotifyTranslatorProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
function TSpNotifyTranslator.InitWin32Event(var hEvent: Pointer; fCloseHandleOnRelease: Integer): HResult;
begin
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpNotifyTranslatorProperties.Create(AServer: TSpNotifyTranslator);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpNotifyTranslatorProperties.GetDefaultInterface: ISpNotifyTranslator;
begin
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpResourceManagerProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpResourceManager.GetServerProperties: TSpResourceManagerProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpResourceManagerProperties.Create(AServer: TSpResourceManager);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpResourceManagerProperties.GetDefaultInterface: ISpResourceManager;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpStreamFormatConverterProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpStreamFormatConverter.GetServerProperties: TSpStreamFormatConverterProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpStreamFormatConverterProperties.Create(AServer: TSpStreamFormatConverter);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpStreamFormatConverterProperties.GetDefaultInterface: ISpStreamFormatConverter;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpMMAudioEnumProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpMMAudioEnum.GetServerProperties: TSpMMAudioEnumProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpMMAudioEnumProperties.Create(AServer: TSpMMAudioEnum);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpMMAudioEnumProperties.GetDefaultInterface: IEnumSpObjectTokens;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpStreamProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpStream.GetServerProperties: TSpStreamProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpStreamProperties.Create(AServer: TSpStream);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpStreamProperties.GetDefaultInterface: ISpStream;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpCompressedLexiconProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpCompressedLexicon.GetServerProperties: TSpCompressedLexiconProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpCompressedLexiconProperties.Create(AServer: TSpCompressedLexicon);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpCompressedLexiconProperties.GetDefaultInterface: ISpLexicon;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSpNullPhoneConverterProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSpNullPhoneConverter.GetServerProperties: TSpNullPhoneConverterProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSpNullPhoneConverterProperties.Create(AServer: TSpNullPhoneConverter);
begin
  inherited Create;
  FServer := AServer;
end;

function TSpNullPhoneConverterProperties.GetDefaultInterface: ISpPhoneConverter;
begin
  Result := FServer.DefaultInterface;
end;

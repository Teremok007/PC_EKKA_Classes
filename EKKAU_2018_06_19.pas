...
*)
    ...
    EKKA_N707: begin  //fpCancelServiceReceipt
(*
                 curr_check.Clear;
*)
               end;
...
*)
    ...
    EKKA_N707: begin  //fpClearServiceText
(*
                 EKKA.FLastError:='';
                 if PrintZerroCheck(ErrCode,ErrMess,curr_chek,IPAddr) then
                 begin
...
begin
  ...
  Result:=False;
  Case TypeEKKA of
    EKKA_MARRY301MTM: begin//Result:=inherited fpCloseServiceReceipt;
                        try
                          s:='CANC'+
                             'CTXT';
                          fpSendCommand(s);
...
*)
    ...
    EKKA_N707: begin  //fpCloseServiceReceipt
(*
                 Result:=ReConnect; if Not Result then Exit;
                 Case TypeOplat of
                   1: Ty:=3; //Оплата в кредит
...
*)
    ...
    EKKA_N707: begin  //fpOpenServiceReceipt
(*
                 Result:=ReConnect;
                 if Not Result then Exit;
                 curr_check.Clear;
